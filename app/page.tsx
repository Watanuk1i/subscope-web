...
const TRUST: { icon: IconName; text: string }[] = [
  { icon: 'shield', text: 'Без данных банковских карт' },
      ...
      <main className="flex-1">
        ...
        <section id="pricing" className="mx-auto max-w-7xl scroll-mt-24 px-4 py-20 sm:px-6">
          ...
          <p className="mt-6 text-center text-xs text-mute">
            Отмена в любой момент · приложение не хранит банковские данные
          </p>
        </section>
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.85fr_1.15fr]">
            <Reveal>
              ...
              <p className="mt-4 text-sm leading-relaxed text-body">
                SUBSCOPE — это учёт и аналитика, а не платёжный сервис. Чтобы посчитать расходы, не
                нужно никому отдавать карту.
              </p>
