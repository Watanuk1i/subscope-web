...
const TRUST: { icon: IconName; text: string }[] = [
  { icon: 'receipt', text: 'Все расходы — в одном чеке' },
...
const FAQ: { q: string; a: string }[] = [
  {
    q: 'Что SUBSCOPE делает за меня?',
    a: 'Собирает все подписки в один список, переводит годовые и еженедельные списания в понятную цену за месяц и показывает, куда утекают деньги. Вместо общих советов — готовый план шагов с суммами: что отменить, где сменить тариф, кому выгодно платить за год.',
  },
  {
  ...
  {
    q: 'Как окупается платный тариф?',
    a: 'Средняя найденная переплата — несколько сотен рублей в месяц: неиспользуемые сервисы, дорогие тарифы, ежемесячная оплата там, где выгоднее годовая. Одна такая находка покрывает стоимость PRO на несколько месяцев вперёд, а счётчик экономии в кабинете показывает результат в рублях.',
  },
  {
  ...
  {
    q: 'За что я плачу на PRO и PRO+?',
    a: 'За инструменты экономии: расширенную аналитику и историю расходов, прогноз на год вперёд, сценарии экономии и сравнение тарифов сервисов. Оплата оформляется на странице чекаута за пару кликов, чек приходит на почту, а отключить продление можно в любой момент.',
  },
  {
...
const VALUE: { icon: IconName; t: string; d: string }[] = [
  {
    icon: 'receipt',
    t: 'Все регулярные платежи в одном чеке',
    d: 'Месяц, год и пять лет пересчитываются мгновенно при любом изменении списка',
  },
  {
    icon: 'spark',
    t: 'Каталог из 17 сервисов с ценами',
    d: 'Название и цена подставляются сами, сервис подсказывает более дешёвые тарифы',
  },
  {
    icon: 'calendar',
    t: 'Календарь списаний на 30 дней',
    d: 'Заранее видно, в какой день и сколько спишется, — без сюрпризов',
  },
  {
    icon: 'savings',
    t: 'Рекомендации с суммами, а не советы',
    d: 'Отменить, сменить тариф или перейти на год — по каждому шагу видна экономия',
  },
];
    ...
    <>
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 pb-12 pt-6 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12 lg:pb-16 lg:pt-10">
            <div>
              <Reveal>
        ...
        <section id="pricing" className="mx-auto max-w-7xl scroll-mt-24 px-4 py-20 sm:px-6">
          ...
          <p className="mt-6 text-center text-xs text-mute">
            Отмена в любой момент · бесплатный тариф бессрочный
          </p>
        </section>

        <section id="value" className="scroll-mt-24 border-t border-line bg-white py-20">
          <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.85fr_1.15fr]">
            <Reveal>
              ...
              <h2 className="mt-3 font-display text-2xl font-black leading-tight text-ink sm:text-3xl">
                Что вы получаете за цену тарифа
              </h2>
              <p className="mt-4 text-sm leading-relaxed text-body">
                Бесплатный тариф бессрочный и уже наводит порядок в расходах. PRO и PRO+ добавляют
                инструменты, которые находят деньги: средняя переплата, которую видит сервис, —
                несколько сотен рублей в месяц, поэтому тариф окупается первой отменённой лишней
                подпиской.
              </p>
